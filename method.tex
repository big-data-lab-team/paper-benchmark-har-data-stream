...
used the release 1.0 and the DOI is \href{https://doi.org/10.5281/zenodo.4148947}{10.5281/zenodo.4148947}.
...
\begin{itemize}
		\item \texttt{Git} to download the repository and its submodule.
		...
		\item \texttt{Python}, \texttt{seaborn}, \texttt{matplotlib}, and
				\texttt{pandas}, to organize the experiment and make the plots.
\end{itemize}
}
