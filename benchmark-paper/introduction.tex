...
\revision{
There was also comparisons made with
...
cupboard. The Opportunity dataset has, in addition, wearable sensors placed on
...
excludes daily activities and the field of Ambient Assisted Living. Additionally,
...
run on a regular computer, so even though comparison between algorithm is valid, we
